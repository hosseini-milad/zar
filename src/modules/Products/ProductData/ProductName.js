      ...
      <div className="pd-row">
        ...
        <div className="row-box">
          <div className="details-wrapper">
            <StyleInput
              title={tabletrans.productName[props.lang]}
            ...
            />
            <StyleInput
              title={tabletrans.productenName[props.lang]}
              direction={props.direction}
              class={"formInput"}
            ...
            />
            <StyleInput
              title={tabletrans.productUrl[props.lang]}
              direction={props.direction}
              class={"formInput"}
              defaultValue={content ? content.productUrl : ""}
              action={(e) =>
                props.setProductChange((prevState) => ({
                  ...prevState,
                  productUrl: e,
            ...
            />
            <StyleInput
              title={tabletrans.metaTitle[props.lang]}
              direction={props.direction}
              class={"formInput"}
            ...
            <div className="contentTextEditor">
              <textarea
                placeholder={tabletrans.productMeta[props.lang]}
            ...
            <div className="images">
              ...
              {EmptyImg?<></>:<img
                src={
                  props.productChange.imageUrl
                    ? env.siteApiUrl + props.productChange.imageUrl
                    : content
                    ? env.siteApiUrl + content.thumbUrl
                    : ""
                }
