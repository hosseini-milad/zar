  ...
  const SavePara = () => {
    ...
    fetch(env.siteApi + "/setting/update-params", postOptions)
      ...
      .then(
        (result) => {
          if (result.error) {
            setErrorPop({ msg: result.error, color: "red" });
            setTimeout(() => {
              setErrorPop("");
            }, 2000);
          }
  ...
  return (
    <div className="profiles" style={{ direction: direction }}>
      <div className="profiles-header">
        ...
        {!Edit ? (
          <div className="add-profile-btn" onClick={() => setEdit(1)}>
            <i
              className="fa-solid fas fa-edit"
              style={{ color: "#ffffff" }}
            ></i>
          ...
          <div className="btn-wrapper">
            ...
            <div
              className="add-profile-btn cancel-btn"
              onClick={() => setEdit(0)}
            >
      ...
      <div
        className={
          direction === "ltr"
            ? "profile-table SS-table"
            : "profile-table SS-table profileRtl"
        }
      >
        <table>
          <thead>
            ...
            <tr>
              ...
              <td>
                {Edit ? (
                  ...
                  <p className="num-view">
                    {content.tax && content.tax[0].percent}
                  </p>
                )}
              </td>
            </tr>
            <tr>
              ...
              <td>
                {Edit ? (
                  ...
                  <p className="num-view">
                    {content.prepaid && content.prepaid[0].percent}
                  </p>
                )}
              </td>
            </tr>
      ...
      {ErrorPop ? (
        <ErrorShow message={ErrorPop.msg} color={ErrorPop.color} />
      ) : (
        <></>
      )}
    </div>
