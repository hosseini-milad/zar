    ...
    <>
      <tr className={`product-tr ${data.purchase ? "purchase-tr" : ""}`}>
        ...
        {data.purchase ? (
          ...
          <td data-cell="مبلغ به ازای هر گرم">
            <p>
              {normalPriceCount(data.priceDetail && data.priceDetail.unitGold)}
            </p>
          </td>
        )}
        ...
        <td
          data-cell="مبلغ کل"
          className={!data.count && data.purchase ? "long-td" : ""}
        >
          {editMode ? (
            <div className="code-input-wrapper new-input">
              <FormattedInputs
                setSendBank={setChanges}
                SendBank={changes}
                type={"Total"}
              />
            </div>
        ...
        <td className="long-td">
          {editMode ? (
            <div className="more-btn">
              <i className="fa-solid fa-save" onClick={updateField}></i>
              <i
